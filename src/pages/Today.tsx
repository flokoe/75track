...
import { TaskList, ProgressBar, StreakCounter } from '../components';
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Welcome to 75track</h1>
          <p className="text-gray-600 mb-8">Start your challenge journey today</p>
          <Link
            to="/setup"
            className="inline-block bg-blue-500 text-white px-8 py-3 rounded-xl font-semibold hover:bg-blue-600 transition-colors"
          >
            Start a Challenge
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-lg mx-auto p-4 pb-24">
        ...
        {/* Celebration */}
        {allComplete && (
          <div className="bg-green-50 border-2 border-green-500 rounded-2xl p-4 mb-6 text-center">
            <span className="text-4xl">🎉</span>
            <p className="text-green-700 font-semibold mt-2">Day Complete!</p>
          </div>
        )}
